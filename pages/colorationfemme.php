...
<div class="option" class="menu-toggle" id="menu-toggle">
    <li><a href="/pages/horaire.html?service=Brush couleur court" class="service">
            <h3>Brush couleur court</h3>
            <p>75min, 50 euros</p>
        </a></li>
    <li><a href="/pages/horaire.html?service=Brush couleur long" class="service">
            <h3>Brush couleur long</h3>
            <p>90 min, 70 euros</p>
        </a></li>
    <li><a href="/pages/horaire.html?service=Couleur coupe court" class="service">
            <h3>Couleur coupe court</h3>
            <p>105min, 75 euros</p>
        </a></li>
    <li><a href="/pages/horaire.html?service=Couleur coupe longue" class="service">
